...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of MessageDemoKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/MessageDemoKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Apple' => 'mm1073856565' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/MessageDemoKit.git', :tag => s.version.to_s }
